...
var _ = cmd.GoUnusedProtection__

func Usage() {
  fmt.Fprintln(os.Stderr, "Usage of ", os.Args[0], " [-h host:port] [-u url] [-f[ramed]] function [arg1 [arg2...]]:")
  flag.PrintDefaults()
  fmt.Fprintln(os.Stderr, "\nFunctions:")
  fmt.Fprintln(os.Stderr, "  string callCommand(command cmd)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := cmd.NewRemoteCmdServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "callCommand":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "CallCommand requires 1 args")
      flag.Usage()
    }
    arg9 := flag.Arg(1)
    ...
    value0 := argvalue0
    fmt.Print(client.CallCommand(context.Background(), value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
